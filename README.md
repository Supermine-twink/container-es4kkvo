...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-es4kkvo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-es4kkvo.containers.anotherwebservice.com/
...
```
git clone git@github.com:Supermine-twink/container-es4kkvo.git
cd container-es4kkvo
```
...
```
docker attach container-es4kkvo
```
